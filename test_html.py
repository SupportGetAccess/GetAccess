        ...
        <tr><td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background: #12122a; border-radius: 20px; overflow: hidden;">
                ...
                <tr><td style="padding: 40px 30px;">
                    <h2 style="margin: 0 0 20px 0; color: #f8fafc; font-size: 24px;">¡Bienvenido Guillermo!</h2>
                    <p style="margin: 0 0 30px 0; color: #94a3b8; font-size: 16px;">Gracias por registrarte. Tu código de verificación:</p>
                    <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding: 20px; background: rgba(99, 102, 241, 0.1); border-radius: 12px; border: 2px solid #6366f1;">
                        <span style="color: #6366f1; font-size: 14px; font-weight: 600; letter-spacing: 2px;">CÓDIGO</span>
                        <br><br>
                        <span style="color: #f8fafc; font-size: 36px; font-weight: 800; letter-spacing: 8px;">123456</span>
                    </td></tr></table>
                </td></tr>

...
html = """<!DOCTYPE html><html><body style="margin:0;background:#0a0a1a;font-family:Segoe UI;">
...
<span style="color:#f8fafc;font-size:36px;font-weight:800;">""" + codigo + """</span></div></td></tr></table></td></tr></table></body></html>"""
